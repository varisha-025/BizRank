          ...
          <div className="flex justify-center">
            <div className="rounded-xl shadow-lg bg-[#3d3d3d] max-w-sm ">
              <div className="pt-3 px-4">
                <h5 className="text-white text-[1.25rem] font-medium  pt-2">Add essential information</h5>
              </div>
              <img className="rounded-t-lg px-6 pt-8" src={img1} alt="an illustrtaion for information" />
          ...
          <div className="flex justify-center">
            <div className="rounded-xl shadow-lg bg-[#3d3d3d] max-w-sm ">
              <div className="pt-2 px-4">
                <h5 className="text-white text-[1.25rem] font-medium mb-2 pt-2">Share product photos, brand logo and your goals</h5>
              </div>
              <img className="rounded-t-lg px-6 pt-1" src={img2} alt="an illustration for branding and awareness" />
          ...
          <div className="flex justify-center">
            <div className="rounded-xl shadow-lg bg-[#3d3d3d] max-w-sm ">
              <div className="px-4 pt-2">
                <h5 className="text-white text-[1.25rem] font-medium  pt-2">Add sale info</h5>
              </div>
              <img className="rounded-t-lg px-6 pt-8" src={img3} alt="an illustration for sale" />
              <div className="px-4 pt-[1rem]">
                <p className="text-white text-[1.075rem] text-base">
      ...
      <div className='bg-black text-white pb-28 pt-12'>
        <div className='w-[72rem] mx-auto flex justify-between items-center pb-20'>
          <div>
            ...
            <p className='text-[1.075rem] pt-3'>Update customers with the latest via posts, offers and more. These business reviews will improve your business's search engine visibility and increase the odds that local customers will find you.</p>
        ...
        <div className='pr-40'>
          ...
          <div>
            <h2 className='text-[2.275rem]'>Show what you sell from clothing to electronics</h2>
            <p className='text-[1.075rem] pt-3'>Whether you're a small business owner operating from the comfort of your home or a service provider your profile helps customers do business with you easily and contact directly with you.</p>
          </div>
          
        </div>
        <div className='w-[72.5rem] mx-auto flex justify-between items-center py-20'>
          <div>
            <h2 className='text-[2.275rem]'>Invite your customers to rate your business</h2>
            <p className='text-[1.075rem] pt-3 w-[42rem]'>Invite your customers to rate your products and your brand. Collecting reviews and responding to them shows that you care about customers feedback. More reviews will help you rank higher and get better reach. Taking remedy steps to correct a bad review will build more customer loyality in the long run.</p>
